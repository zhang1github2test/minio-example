...
docker run  -d \
   ...
   --name minio2 \
   -v ~/minio2/data:/data \
   -v ~/minio2/log:/var/log/minio \
   -e MINIO_LOG_DIR="/var/log/minio" \
   -e MINIO_LOGGER_WEBHOOK_ENABLE_FIRST="on"
   -e MINIO_LOGGER_WEBHOOK_ENDPOINT_FIRST="http://8.136.102.104:8095/server-log"
   -e MINIO_LOGGER_WEBHOOK_AUTH_TOKEN_FIRST="TOKEN"
   -e MINIO_LOG_COMPRESS=true
   quay.io/minio/minio server /data --console-address ":9001" 
```

docker run  -d   -p 19000:9000    -p 19001:9001    --name minio3    -v ~/minio2/data:/data    -v ~/minio2/log:/var/log/minio    -e MINIO_LOG_DIR="/var/log/minio"      -e MINIO_LOG_PREFIX="log"    -e MINIO_LOG_COMPRESS=true    quay.io/minio/minio server /data --console-address ":9001"
