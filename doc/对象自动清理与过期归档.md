...
./mc mb remote/bucket-lifecycle
 # 添加远端存储
./minio-binaries/mc  ilm tier add minio minio WARM-MINIO-TIER --endpoint http://172.17.73.141:19000 --access-key minioadmin  --secret-key minioadmin --bucket bucket-lifecycle   --prefix myprefix
